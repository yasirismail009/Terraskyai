...
const events = [
  {
    ...
    images: [
      "/assets/Ag_Expo1.jpeg",
      "/assets/Ag_Expo2.jpeg",
      "/assets/Ag_Expo3.jpeg",
    ],
  },
  {
    id: 2,
    ...
    images: [
      ...
      "/assets/Career-Fair1.jpeg",
      "/assets/Career-Fair2.jpeg",
      "/assets/Career-Fair3.jpeg",
    ],
  },
];
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#FDFCF5", overflowX: "hidden" }}>
      ...
      <section className="gl-hero">
        {/* Decorative rings */}
        <div className="gl-hero-ring" style={{ width:500, height:500, top:"50%", left:"50%", transform:"translate(-50%,-50%)" }} />
        <div className="gl-hero-ring" style={{ width:350, height:350, top:"50%", left:"50%", transform:"translate(-50%,-50%)" }} />
        <div className="gl-hero-ring" style={{ width:200, height:200, top:"50%", left:"50%", transform:"translate(-50%,-50%)", borderColor:"rgba(190,169,80,0.2)" }} />

        {/* Glows */}
        <div className="gl-hero-glow" style={{ width:400, height:400, top:"-10%", left:"15%", background:"radial-gradient(circle, rgba(190,169,80,0.12) 0%, transparent 70%)" }} />
        <div className="gl-hero-glow" style={{ width:300, height:300, bottom:"-5%", right:"10%", background:"radial-gradient(circle, rgba(139,94,60,0.1) 0%, transparent 70%)" }} />

        {/* Dot bg */}
        <div className="gl-dot-bg" style={{ position:"absolute", inset:0, pointerEvents:"none", opacity:0.6 }} />
        ...
        <div style={{ position:"relative", maxWidth:720, margin:"0 auto" }}>
          ...
          <div style={{
            ...
            marginBottom:24, animation:"gl-fadeUp 0.6s 0.15s ease both",
          }}>
            <div style={{ height:1, width:48, background:"linear-gradient(90deg,transparent,rgba(190,169,80,0.5))" }} />
            <div style={{ width:5, height:5, borderRadius:"50%", background:"#BEA950" }} />
            <div style={{ height:1, width:48, background:"linear-gradient(90deg,rgba(190,169,80,0.5),transparent)" }} />
          </div>
          ...
          <p style={{
            ...
            From expos to career fairs — moments where TerraSkyAI connects with growers, students, and innovators shaping the future of agriculture.
          </p>
        </div>
      </section>
      ...
      {events.map((event, idx) => (
        <section key={event.id} className="gl-section">
          <div className="gl-dot-bg" style={{ position:"absolute", inset:0, pointerEvents:"none" }} />
          ...
          <div style={{ maxWidth:1200, margin:"0 auto", position:"relative" }}>
            ...
            <div className="gl-event-label" style={{ marginBottom:44 }}>
              <div style={{ display:"flex", alignItems:"center", gap:16, flexWrap:"wrap", marginBottom:12 }}>
                ...
                <span style={{
                  fontFamily:"'DM Sans',sans-serif",
                  fontSize:13, color:"#9a9878",
                  display:"flex", alignItems:"center", gap:6,
                }}>
                  <svg viewBox="0 0 16 16" fill="none" style={{ width:13, height:13 }}>
                    <path d="M8 1.5C5.5 1.5 3.5 3.5 3.5 6c0 3.5 4.5 8.5 4.5 8.5s4.5-5 4.5-8.5c0-2.5-2-4.5-4.5-4.5z" stroke="#9a9878" strokeWidth="1.3"/>
            ...
            >
              {/* Image grid */}
              <div style={{ order: idx % 2 === 0 ? 0 : 1, display:"flex", flexDirection:"column" }}>
                <div className="gl-img-grid" style={{ flex:1 }}>
                  {event.images.map((src, i) => (
                    ...
                    >
                      <img src={src} alt={`${event.name} ${i + 1}`} />
                      <div className="gl-img-overlay">
                        <div className="gl-zoom-icon">
                          <svg viewBox="0 0 20 20" fill="none" style={{ width:18, height:18 }}>
                            ...
                            <path d="M13.5 13.5l3 3" stroke="white" strokeWidth="1.5" strokeLinecap="round"/>
      ...
      <section style={{
        ...
        <div className="gl-dot-bg" style={{ position:"absolute", inset:0, pointerEvents:"none", opacity:0.5 }} />
        <div style={{ position:"absolute", top:"50%", left:"50%", transform:"translate(-50%,-50%)", width:500, height:500, borderRadius:"50%", border:"1px solid rgba(190,169,80,0.08)", pointerEvents:"none" }} />
        <div style={{ position:"absolute", top:"50%", left:"50%", transform:"translate(-50%,-50%)", width:320, height:320, borderRadius:"50%", border:"1px solid rgba(190,169,80,0.12)", pointerEvents:"none" }} />
        ...
        <div style={{ position:"relative", maxWidth:560, margin:"0 auto" }}>
          ...
          <a
            ...
            style={{
              ...
              background:"#BEA950", color:"#1a1d06",
      ...
      {lightbox && (
        <div className="gl-lightbox" onClick={() => setLightbox(null)}>
          <div className="gl-lightbox-inner" onClick={e => e.stopPropagation()}>
            ...
            <img src={lightbox.src} alt={lightbox.eventName} />
