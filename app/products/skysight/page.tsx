  ...
  return (
    <div className="min-h-screen" style={{ background: '#FDFCF5' }}>
      ...
      <section
        ...
        style={{ minHeight: '88vh', paddingTop: 80 }}
      >
        <div
          style={{
            position: 'absolute',
        ...
        <div
          style={{
            position: 'absolute',
            inset: 0,
            background: 'linear-gradient(160deg, rgba(30,32,9,0.75) 0%, rgba(69,68,17,0.58) 100%)',
          }}
        />
        <div
          className="ss-fade relative z-10 text-center"
        ...
        >
          <div
            style={{
              ...
              padding: '6px 20px',
              borderRadius: 999,
              background: 'rgba(190,169,80,0.15)',
      ...
      >
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <div className="ss-fade" style={{ textAlign: 'center', marginBottom: 56 }}>
            ...
            >
              Everything You Need to <em style={{ color: '#8B5E3C' }}>Run Your Farm</em>
            </h2>
