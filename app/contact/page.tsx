...
function parseQueryCreated(
  ...
  if (raw && typeof raw === 'object' && typeof (raw as { id?: unknown }).id === 'string') {
    ...
    return {
      ...
      area_of_interest: typeof o.area_of_interest === 'string' ? o.area_of_interest : fallback.area_of_interest,
  ...
  return (
    <div className="c-success-wrap" role="status">
      ...
      <p className="c-success-sub">
        We received your message and will follow up by email. Keep this reference handy if you contact support.
      </p>
          ...
          <div style={{ background:"#FDFCF5", borderRadius:24, padding:"36px 32px", boxShadow:"0 24px 64px rgba(0,0,0,0.35)", border:"1.5px solid rgba(240,237,220,1)" }}>
            ...
            <h2 style={{ fontFamily:"'Cormorant Garamond',Georgia,serif", fontSize:"1.8rem", fontWeight:700, color:"#2d2e0a", lineHeight:1.2, marginBottom:24 }}>
              {submittedQuery ? (
                <>
                  Inquiry{' '}
                  <em style={{ color: '#BEA950', fontStyle: 'normal' }}>received</em>
                </>
              ) : (
            ...
            <form onSubmit={handleSubmit}>
              {submitError ? (
                <p role="alert" style={{ fontFamily:"'DM Sans',sans-serif", fontSize:13, color:"#a33", marginBottom:14, lineHeight:1.5 }}>
                  {submitError}
                </p>
              ) : null}
              ...
              <div style={{ display:"flex", flexWrap:"wrap", alignItems:"center", justifyContent:"space-between", gap:12 }}>
                <button type="submit" className="c-btn" disabled={submitLoading} aria-busy={submitLoading}>
