...
const coreValues = [
  {
    ...
    icon: (
      <svg viewBox="0 0 48 48" fill="none" className="w-9 h-9">
        ...
        <path
          d="M20 22 C20 22 17 20 16 17 C18 17 20 19 20 19"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
        ...
        />
        <path
          d="M20 21 C20 21 23 19 24 16 C22 16 20 18 20 18"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 48 48" fill="none" className="w-9 h-9">
        ...
        <path
          d="M16.5 19 L14 17M16.5 21 L14 21M16.5 23 L14 25"
          stroke="currentColor"
          strokeWidth="1.3"
          strokeLinecap="round"
        />
        <path
          d="M23.5 19 L26 17M23.5 21 L26 21M23.5 23 L26 25"
          stroke="currentColor"
          strokeWidth="1.3"
          strokeLinecap="round"
        />
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 48 48" fill="none" className="w-9 h-9">
        ...
        />
        <path
          d="M20 26 C20 26 13 23 14 15 C14 15 22 15 23 22 C23 22 23 24 20 26Z"
          stroke="currentColor"
          strokeWidth="1.5"
          fill="currentColor"
          fillOpacity="0.2"
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 48 48" fill="none" className="w-9 h-9">
        ...
        />
        <path
          d="M14 21 C14 17 17 14 20 14 C23 14 26 17 26 21 C26 24 23 27 20 27 C17 27 14 24 14 21Z"
          stroke="currentColor"
          strokeWidth="1.5"
          fill="currentColor"
          fillOpacity="0.15"
    ...
    >
      ...
      <div
        style={{
          ...
          height: 500,
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(190,169,80,0.09) 0%, transparent 70%)',
          filter: 'blur(60px)',
          pointerEvents: 'none',
        }}
      />
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 28px', position: 'relative' }}>
        <div
          className={headerVisible ? 'cv-hdr-show' : 'cv-hdr-hide'}
          ...
          >
            <div
              style={{
                height: 1,
                width: 64,
                background: 'linear-gradient(90deg, transparent, #BEA950)',
              }}
            />
            ...
            <div
              style={{
                height: 1,
                width: 64,
                background: 'linear-gradient(90deg, #BEA950, transparent)',
              }}
            />
          </div>
        </div>
          ...
          {coreValues.map((val, i) => (
            <div
              ...
              style={{
                ...
                boxShadow:
                  activeIndex === i
                    ? `0 24px 60px rgba(0,0,0,0.38), 0 0 0 1.5px ${val.color}22`
            ...
            >
              <div
                style={{ position: 'relative', width: '100%', height: '290px', overflow: 'hidden' }}
              >
                <div
                  style={{
                    position: 'absolute',
                    inset: 0,
                    background: `linear-gradient(135deg, ${val.accentLight} 0%, #dedad0 100%)`,
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                  }}
                >
                  <div style={{ color: val.color, opacity: 0.15, transform: 'scale(2.5)' }}>
                    {val.icon}
                  </div>
                </div>
                <Image
                ...
                <div
                  style={{
                    ...
                    inset: 0,
                    background:
                      'linear-gradient(to top, rgba(30,32,9,0.6) 0%, rgba(30,32,9,0.1) 45%, transparent 100%)',
                  }}
                />
                <div
                  className="cv-tag"
                  style={{
                    ...
                    color: val.color,
                    border: `1px solid ${val.accentBorder}`,
              ...
              <div style={{ padding: '16px 20px 20px' }}>
                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      height: 42,
                      borderRadius: '12px',
                      background: val.accentLight,
                      border: `1.5px solid ${val.accentBorder}`,
                      color: val.color,
                      display: 'flex',
                      alignItems: 'center',
                      justifyContent: 'center',
                ...
                <div
                  style={{
                    height: 1,
                    margin: '10px 0',
                    background: `linear-gradient(90deg, ${val.color}35, transparent)`,
                  }}
                />
