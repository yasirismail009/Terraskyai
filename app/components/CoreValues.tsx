    ...
    >
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 28px", position: "relative" }}>
        ...
        <div className={headerVisible ? "cv-hdr-show" : "cv-hdr-hide"} style={{ textAlign: "center", marginBottom: "60px" }}>
          ...
          <h2 style={{ fontSize: "clamp(2rem, 4vw, 2.9rem)", fontWeight: 800, color: "#f5f2e8", letterSpacing: "-0.02em", lineHeight: 1.2, marginBottom: "14px", fontFamily: "'Cormorant Garamond', Georgia, serif" }}>
      <span style={{ color: "#BEA950" }}>AI-Powered Precision Agriculture Analytics</span>
          </h2>
          <p style={{ color: "#9a9878", fontSize: "1.05rem", maxWidth: 580, margin: "0 auto", lineHeight: 1.75, fontFamily: "'DM Sans', sans-serif" }}>
            ...
            >
              ...
              <div style={{ padding: "16px 20px 20px" }}>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, marginBottom: 6 }}>
                  <h3 style={{ color: "#2d2e0a", fontSize: "1.2rem", fontWeight: 800, lineHeight: 1.25, fontFamily: "'Cormorant Garamond', Georgia, serif" }}>{val.title}</h3>
                ...
                <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 7 }}>
                  {val.points.map((pt, j) => (
                    <li key={j} style={{ display: "flex", alignItems: "flex-start", gap: 10 }}>
                      ...
                      <span style={{ color: "#555", fontSize: "13px", lineHeight: 1.5, fontFamily: "'DM Sans', sans-serif" }}>{pt}</span>
                    </li>
                  ))}
                </ul>

                {val.highlight && (
                  <div style={{ marginTop: 16, display: "inline-flex", alignItems: "center", gap: 7, background: val.accentLight, border: `1.5px solid ${val.accentBorder}`, color: val.color, borderRadius: "10px", padding: "7px 14px", fontSize: "13px", fontWeight: 700, fontFamily: "'DM Sans', sans-serif" }}>
