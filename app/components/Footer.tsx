...
export default function Footer() {
  return (
    ...
    >
      ...
      {/* Texture */}
      <div className="ft-dot-grid" style={{ position:"absolute", inset:0, pointerEvents:"none" }} />

      {/* Glow orbs */}
      <div className="ft-glow1" style={{ position:"absolute", top:-80, left:-60, width:400, height:400, borderRadius:"50%", background:"radial-gradient(circle, rgba(69,68,17,0.05) 0%, transparent 70%)", filter:"blur(50px)", pointerEvents:"none" }} />
      <div className="ft-glow2" style={{ position:"absolute", bottom:-60, right:-60, width:360, height:360, borderRadius:"50%", background:"radial-gradient(circle, rgba(139,94,60,0.04) 0%, transparent 70%)", filter:"blur(50px)", pointerEvents:"none" }} />

      {/* Decorative rings */}
      <div className="ft-ring1" style={{ position:"absolute", top:"10%", right:"5%", width:180, height:180, borderRadius:"50%", border:"1px dashed rgba(69,68,17,0.08)", pointerEvents:"none" }} />
      <div className="ft-ring2" style={{ position:"absolute", bottom:"15%", left:"3%", width:130, height:130, borderRadius:"50%", border:"1px dashed rgba(139,94,60,0.07)", pointerEvents:"none" }} />

      <div style={{ maxWidth:1200, margin:"0 auto", padding:"64px 28px 0", position:"relative" }}>
        ...
        {/* ── Main grid ── */}
        <div className="ft-main-grid" style={{ display:"grid", gridTemplateColumns:"2fr 1fr 1fr 1.4fr", gap:"40px 32px" }}>
          ...
          <div>
            ...
            <p style={{ fontSize:13.5, color:"#545454", lineHeight:1.8, maxWidth:280, marginBottom:24 }}>
              Revolutionizing agriculture through AI-powered precision farming. Empowering farmers with actionable insights for sustainable, efficient crop management.
            </p>
            {/* Socials */}
          ...
          <div>
            ...
            <ul style={{ listStyle:"none", padding:0, margin:0, display:"flex", flexDirection:"column", gap:10 }}>
              {[
                ...
                { label:"SkySight",      href:"/products/skysight" },
            ...
            <div style={{ marginTop:28 }}>
              ...
              <div style={{ display:"flex", flexDirection:"column", gap:8 }}>
                <a href="tel:+15875741601" className="ft-link" style={{ display:"flex", alignItems:"center", gap:7 }}>
                ...
                <a href="mailto:support@terraskyai.com" className="ft-link" style={{ display:"flex", alignItems:"center", gap:7 }}>
                  <svg viewBox="0 0 24 24" fill="none" style={{ width:13, height:13, flexShrink:0 }}>
        ...
        {/* ── Bottom bar ── */}
        <div style={{ paddingBottom:28, display:"flex", flexWrap:"wrap", alignItems:"center", justifyContent:"space-between", gap:14 }}>
