    ...
    <div className="min-h-screen bg-[#E6E2D6] relative overflow-hidden">
      ...
      >
        <style>{`
          ...
          .prod-card-2:hover { box-shadow: 0 20px 60px rgba(45,46,10,0.55); }
          ...
          .prod-card:hover .prod-cta {
            ...
            border-color: rgba(255,255,255,0.4); gap: 14px;
          }
      ...
      >
        <style>{`
          ...
          .wu-video-wrap { animation: wu-fadeLeft 0.75s 0.1s ease both; }
          .wu-content    { animation: wu-fadeRight 0.75s 0.2s ease both; }
          .wu-stat { animation: wu-countUp 0.6s ease both; }
          ...
          .wu-feature-item:hover .wu-icon-circle { transform: scale(1.1) rotate(-5deg); }
          .wu-bar-track {
